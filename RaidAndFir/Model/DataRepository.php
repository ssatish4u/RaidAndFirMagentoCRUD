...
use Iksula\RaidAndFir\Api\Data\DataSearchResultsInterfaceFactory;
use Iksula\RaidAndFir\Model\ResourceModel\Data as ResourceData;
use Iksula\RaidAndFir\Model\ResourceModel\Data\CollectionFactory as DataCollectionFactory;
...
class DataRepository implements DataRepositoryInterface
{
    ...
    public function getById($dataId)
    {
        if (!isset($this->instances[$dataId])) {
            /** @var \Iksula\RaidAndFir\Api\Data\DataInterface|\Magento\Framework\Model\AbstractModel $data */
     ...
     * @return \Iksula\RaidAndFir\Api\Data\DataSearchResultsInterface
     */
    public function getList(SearchCriteriaInterface $searchCriteria)
    {
        /** @var \Iksula\RaidAndFir\Api\Data\DataSearchResultsInterface $searchResults */
        $searchResults = $this->searchResultsFactory->create();
        $searchResults->setSearchCriteria($searchCriteria);

        /** @var \Iksula\RaidAndFir\Model\ResourceModel\Data\Collection $collection */
